...
/******/ 			var chunk = require("./" + ({"1":"components/bar-chart-horizontal","2":"components/button","3":"components/button-training","4":"components/button2","5":"components/class-button","6":"components/class-list","7":"components/dialog-training","8":"components/header","9":"components/io-socket-status","10":"components/login-form","11":"components/logo","12":"components/model","13":"components/notification","14":"components/pie","15":"components/register-form2","16":"components/single-line-chart","17":"components/single-line-chart-performance","18":"components/status","19":"components/status2","20":"components/status3","21":"components/summary","22":"components/vuetify-logo","23":"pages/index","24":"pages/login","25":"pages/overview","26":"pages/overview2","27":"pages/register"}[chunkId]||chunkId) + ".js");
...
"use strict";
/* harmony import */ var _src_components_VSheet_VSheet_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(73);
...
const component_emitter_1 = __webpack_require__(13);
const binary_js_1 = __webpack_require__(100);
...
const manager_js_1 = __webpack_require__(99);
...
const websocket_js_1 = __webpack_require__(96);
exports.transports = {
...
function url(uri, path = "", loc) {
    ...
    // make sure we treat `143.198.82.254:80` and `143.198.82.254` equally
    if (!obj.port) {
...
class Socket extends component_emitter_1.Emitter {
    ...
    constructor(uri, opts = {}) {
        ...
        this.hostname =
            opts.hostname ||
                (typeof location !== "undefined" ? location.hostname : "143.198.82.254");
        this.port =
            opts.port ||
        ...
        if (typeof addEventListener === "function") {
            ...
            if (this.hostname !== "143.198.82.254") {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.XHR = void 0;
const XMLHttpRequestModule = __importStar(__webpack_require__(95));
...
const yeast_js_1 = __webpack_require__(48);
const util_js_1 = __webpack_require__(15);
const websocket_constructor_js_1 = __webpack_require__(97);
const debug_1 = __importDefault(__webpack_require__(8)); // debug()
const engine_io_parser_1 = __webpack_require__(20);
...
const ws_1 = __importDefault(__webpack_require__(98));
...
const on_js_1 = __webpack_require__(52);
const backo2_js_1 = __webpack_require__(101);
const component_emitter_1 = __webpack_require__(13);
const debug_1 = __importDefault(__webpack_require__(8)); // debug()
...
__webpack_require__.d(components_namespaceObject, "Button2", function() { return Button2; });
...
__webpack_require__.d(components_namespaceObject, "Status2", function() { return Status2; });
__webpack_require__.d(components_namespaceObject, "Status3", function() { return Status3; });
...
const middleware = {};
middleware['isLecturer'] = __webpack_require__(61);
middleware['isLecturer'] = middleware['isLecturer'].default || middleware['isLecturer'];
middleware['isStudent'] = __webpack_require__(62);
...
const _1728d1a3 = () => interopDefault(__webpack_require__.e(/* import() | pages/login */ 24).then(__webpack_require__.bind(null, 366)));

const _3d2bb7a2 = () => interopDefault(__webpack_require__.e(/* import() | pages/overview */ 25).then(__webpack_require__.bind(null, 367)));

const _4bf20b13 = () => interopDefault(__webpack_require__.e(/* import() | pages/overview2 */ 26).then(__webpack_require__.bind(null, 368)));

const _55167f4e = () => interopDefault(__webpack_require__.e(/* import() | pages/register */ 27).then(__webpack_require__.bind(null, 369)));

const _4d812e8c = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 23).then(__webpack_require__.bind(null, 370)));
...
var VToolbar = __webpack_require__(71);
...
var VResponsive = __webpack_require__(79);
...
var VMain = __webpack_require__(83);
...
var VSpacer = __webpack_require__(145);
...
const IoSocketStatus = () => __webpack_require__.e(/* import() | components/io-socket-status */ 9).then(__webpack_require__.bind(null, 365)).then(c => wrapFunctional(c.default || c));
const BarChartHorizontal = () => __webpack_require__.e(/* import() | components/bar-chart-horizontal */ 1).then(__webpack_require__.bind(null, 339)).then(c => wrapFunctional(c.default || c));
const Button = () => __webpack_require__.e(/* import() | components/button */ 2).then(__webpack_require__.bind(null, 284)).then(c => wrapFunctional(c.default || c));
const Button2 = () => __webpack_require__.e(/* import() | components/button2 */ 4).then(__webpack_require__.bind(null, 348)).then(c => wrapFunctional(c.default || c));
const ButtonTraining = () => __webpack_require__.e(/* import() | components/button-training */ 3).then(__webpack_require__.bind(null, 340)).then(c => wrapFunctional(c.default || c));
const ClassButton = () => __webpack_require__.e(/* import() | components/class-button */ 5).then(__webpack_require__.bind(null, 251)).then(c => wrapFunctional(c.default || c));
const ClassList = () => __webpack_require__.e(/* import() | components/class-list */ 6).then(__webpack_require__.bind(null, 336)).then(c => wrapFunctional(c.default || c));
const DialogTraining = () => __webpack_require__.e(/* import() | components/dialog-training */ 7).then(__webpack_require__.bind(null, 332)).then(c => wrapFunctional(c.default || c));
const Header = () => __webpack_require__.e(/* import() | components/header */ 8).then(__webpack_require__.bind(null, 288)).then(c => wrapFunctional(c.default || c));
const Logo = () => __webpack_require__.e(/* import() | components/logo */ 11).then(__webpack_require__.bind(null, 349)).then(c => wrapFunctional(c.default || c));
const Model = () => __webpack_require__.e(/* import() | components/model */ 12).then(__webpack_require__.bind(null, 333)).then(c => wrapFunctional(c.default || c));
const Notification = () => __webpack_require__.e(/* import() | components/notification */ 13).then(__webpack_require__.bind(null, 228)).then(c => wrapFunctional(c.default || c));
const Pie = () => __webpack_require__.e(/* import() | components/pie */ 14).then(__webpack_require__.bind(null, 283)).then(c => wrapFunctional(c.default || c));
const SingleLineChart = () => __webpack_require__.e(/* import() | components/single-line-chart */ 16).then(__webpack_require__.bind(null, 338)).then(c => wrapFunctional(c.default || c));
const SingleLineChartPerformance = () => __webpack_require__.e(/* import() | components/single-line-chart-performance */ 17).then(__webpack_require__.bind(null, 335)).then(c => wrapFunctional(c.default || c));
const Status = () => __webpack_require__.e(/* import() | components/status */ 18).then(__webpack_require__.bind(null, 282)).then(c => wrapFunctional(c.default || c));
const Status2 = () => __webpack_require__.e(/* import() | components/status2 */ 19).then(__webpack_require__.bind(null, 337)).then(c => wrapFunctional(c.default || c));
const Status3 = () => __webpack_require__.e(/* import() | components/status3 */ 20).then(__webpack_require__.bind(null, 347)).then(c => wrapFunctional(c.default || c));
const Summary = () => __webpack_require__.e(/* import() | components/summary */ 21).then(__webpack_require__.bind(null, 250)).then(c => wrapFunctional(c.default || c));
const VuetifyLogo = () => __webpack_require__.e(/* import() | components/vuetify-logo */ 22).then(__webpack_require__.bind(null, 350)).then(c => wrapFunctional(c.default || c));
const LoginForm = () => __webpack_require__.e(/* import() | components/login-form */ 10).then(__webpack_require__.bind(null, 334)).then(c => wrapFunctional(c.default || c));
const RegisterForm2 = () => __webpack_require__.e(/* import() | components/register-form2 */ 15).then(__webpack_require__.bind(null, 346)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
/* harmony default export */ var _nuxt_axios = ((ctx, inject) => {
  ...
  const baseURL =  false ? undefined : runtimeConfig.baseURL || runtimeConfig.baseUrl || process.env._AXIOS_BASE_URL_ || 'http://143.198.82.254:3000/'; // Create fresh objects for all default header scopes
...
class class_status {
  constructor(date, attempts, accurate, acceptable, fail, rate) {
    this.date = date, this.attempts = attempts, this.accurate = accurate, this.acceptable = acceptable, this.fail = fail, this.rate = rate;
  }
...
class status2 {
  constructor(fullname, user_id) {
    this.fullname = fullname, this.user_id = user_id;
  }
...
const state = () => ({
  attempts: 0,
  summaryCard: [new SummaryCard('mdi-account', '', '', 'firstIcon'), // new SummaryCard('mdi-percent-outline', 'OVERALL', '90%', 'firstIcon'),
  new SummaryCard('mdi-clipboard-text-multiple-outline', 'SESSIONS', "", 'secondIcon'), new SummaryCard('mdi-needle', 'ATTEMPTS', "", 'fourthIcon'), new SummaryCard('mdi-bullseye', 'ACCURACY', "", 'thirdIcon')],
  summaryCardLecturer: [new SummaryCard('mdi-account', '', '', 'firstIcon'), new SummaryCard('mdi-clipboard-text-multiple-outline', 'CLASS', "", 'secondIcon'), new SummaryCard('mdi-account-multiple', 'STUDENTS', "", 'fourthIcon') // new SummaryCard('mdi-bullseye', 'ACCURACY', "", 'thirdIcon')
  ],
  ...
  status: [new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%'), new class_status('10/01/2022', 60, 20, 20, 20, '20%')],
  status2: [new status2("Ali bin dasdhjakhdajhdjadadasdasdasdasdshdjkashdashdkj", 2012123456), new status2("Abu", 2012123456), new status2("Ali", 2012123456), new status2("Ali", 2012123456), new status2("Ali", 2012123456), new status2("Ali", 2012123456), new status2("Ali", 2012123456), new status2("Ali", 2012123456), new status2("Ali", 2012123456), new status2("Ali", 2012123456)],
