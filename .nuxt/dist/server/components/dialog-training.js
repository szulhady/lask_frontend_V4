...
var VDialog = __webpack_require__(324);
...
var VOverlay = __webpack_require__(326);
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/DialogTraining.vue?vue&type=template&id=4a9b4cc7&
...
var DialogTrainingvue_type_template_id_4a9b4cc7_render = function render() {
  var _vm = this,
      _c = _vm._self._c;
  ...
  return _c(VRow["a" /* default */], {
  ...
  }, [_c(transitions["d" /* VScrollYTransition */], [_c(VDialog_VDialog, {
    attrs: {
      "persistent": "",
      "max-width": "290"
    },
    ...
    staticClass: "text-h5"
  }, [_vm._v(" ACTION ")]), _vm._v(" "), _c(components_VCard["c" /* VCardText */], [_vm._v("Please select device.")]), _vm._v(" "), _c('div', {
    staticStyle: {
      "width": "70%",
      "margin": "auto"
    }
    ...
    on: {
      "click": function ($event) {
        _vm.setOpenDialogTraining(false);
...
// CONCATENATED MODULE: ./components/DialogTraining.vue?vue&type=template&id=4a9b4cc7&
...
/* harmony default export */ var DialogTrainingvue_type_script_lang_js_ = ({
  methods: { ...Object(external_vuex_["mapMutations"])({
    ...
    getDevice: function (id) {
      this.$axios.$get("http://143.198.82.254:8000/api/data/device", {}).then(response => {
    ...
    selectDevice() {
      ...
      let a = this.items.filter(item => item.name == this.selectedDevice); // console.log(a[0]);
  ...
  async mounted() {
    ...
    this.socket.on("room", (msg, cb) => {
      ...
      if (msg != null || msg.length !== 0) {
        const found = this.items.find(element => element.name == msg); // console.log(found.name, "found");

        var index = this.items.map(function (item) {
          return item.name;
        }).indexOf(found.name); // console.log(index);

        this.items[index].disable = true; // console.log(this.items[index].disable);
      }
    });
    this.socket.on("roomclear", (msg, cb) => {
      ...
      if (msg != null) {
        ...
        this.items[index].disable = false; // console.log(this.items[index].disable);
      }
    });
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  DialogTrainingvue_type_template_id_4a9b4cc7_render,
  staticRenderFns,
  false,
  injectStyles,
  null,
